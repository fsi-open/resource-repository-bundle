...
class BoolTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('FSi\Bundle\ResourceRepositoryBundle\Repository\Resource\Type\BoolType');
    }
    ...
    {
        $factory->createNamedBuilder('boolValue', 'checkbox', null, array(
            'label' => 'resource_group.resource_bool.name',
            'required' => false,
